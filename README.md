...
- **Fase «durante» — pattern dell'app di Olga IN VALUTAZIONE (16/8, non deciso)** — Andrea ha chiesto di valutare i 3 bottoni di Olga (Parto / Dove dormo stasera? / Fine tappa) col dubbio esplicito che Parto e Fine tappa non abbiano senso per chi traccia già col proprio GPS da manubrio. Proposta da validare — **3 stati automatici per ora del giorno invece di 3 bottoni** (mattina — la tappa davanti; pomeriggio — «Dove dormo stasera?» in primo piano, l'unico che il Garmin non sa fare e quello che capitalizza con Stay22/POI Partner; sera — routine serale e link al forum riservato agli iscritti), più eventuale «segna dove mi sono fermato» a un tap come segnalibro del Diario. Routine serale dal viaggio NC4K di Andrea — metti in carica GPS e cellulare, ricarica le luci, controlla la bici, lava il completo, crema dopo pedalata, prenota la notte di domani, guarda dove cenare domani. Il 112 e Condividi posizione restano sempre visibili. **La decisione si prende dopo l'evento TG del 26/9 coi dati Umami** su cosa viene usato davvero; motivazioni in D16 sulla pagina Notion linkata sopra.
