...
- **Fase «durante» a 3 bottoni (pattern dell'app di Olga, deciso 16/8)** — la Home in fase durante si ristruttura sui 3 momenti della giornata. **Parto** (mattina — meteo sulla tratta + mini-routine di partenza), **Dove dormo stasera?** (pomeriggio — mete raggiungibili sulla media reale → il momento Stay22/POI Partner), **Fine tappa** (sera — km oggi/totali/media, proiezione d'arrivo «di questo passo», routine serale e link al forum riservato agli iscritti). Routine serale dal viaggio NC4K di Andrea — metti in carica GPS e cellulare, ricarica le luci, controlla la bici, lava il completo, crema dopo pedalata, prenota la notte di domani, guarda dove cenare domani. Il 112 e Condividi posizione restano sempre visibili; la griglia attuale diventa riga secondaria. Fine tappa fa anche da timbro del Diario. Build invernale (~2-3 giorni); motivazioni in D16 sulla pagina Notion linkata sopra.
